...
SECRET_KEY = 'django-insecure-3e)$=pz!k5vfa6#!&k-b!08l^fa9ino1l8j29(9bf$21&225hm'
...
EMAIL_HOST_USER = 'pythonbot64@gmail.com'     # имя пользователя
DEFAULT_FROM_EMAIL = EMAIL_HOST_USER  # email, с которого будет отправлено письмо
EMAIL_HOST_PASSWORD = 'iptnexdhreccqcvq'      # пароль от ящика
